...
def _bbb_specs() -> list[FeatureSpec]:
    return [
        ...
        FeatureSpec(
            ...
            Chain.ROBINHOOD,
            TopicFeature.FRESHIES,
            "Robinhood Chain mainnet + DexScreener",
            max_market_cap_usd=250_000_000,
            notes="Live Uniswap pairs with strict market-quality and risk gating.",
        ),
        FeatureSpec(
            "rh_big_freshies",
            "RH Big Freshies",
        ...
        FeatureSpec(
            ...
            Chain.ROBINHOOD,
            TopicFeature.DEPLOYS,
            "Robinhood Chain mainnet + Uniswap factory logs",
            notes="Same-day mainnet pools discovered from live indexed and onchain evidence.",
        ),
        FeatureSpec(
            "bnb_freshies",
            "BNB Freshies",
